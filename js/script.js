document.addEventListener("DOMContentLoaded", function () {
    ...
    function renderCandidates(filter = 'all') {
        ...
        filteredCandidates.forEach(candidate => {
            ...
            div.innerHTML = `
                ...
                <p><strong>Political Party:</strong> ${candidate.party}</p>
                <p><strong>Age:</strong> ${candidate.age}</p>
                <p><strong>Profession:</strong> ${candidate.job}</p>
                <p><strong>Status:</strong> ${candidate.incumbent ? 'Incumbent' : 'New Candidate'}</p>
            `;
    ...
    document.getElementById("search").addEventListener("input", function () {
        ...
        candidates.forEach(candidate => {
            ...
            const party = candidate.querySelector('.candidate-party').textContent.toLowerCase();
            candidate.style.display = (name.includes(filter) || party.includes(filter)) ? "block" : "none";
        });
    });
